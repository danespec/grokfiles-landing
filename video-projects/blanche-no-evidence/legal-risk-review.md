...
Primary risk: turning records, allegations, or public gaps into unsupported criminal-conduct claims.

Approved language patterns:

- "not publicly located" for missing public analyses.
- "charge document" for indictments.
- "court finding" only for verdict, judgment, jury instruction, or appellate record boundaries.
...
- "DOJ cleared everyone."
- "The files prove no one else was involved."
- "The files prove all allegations."
- "Flight logs prove criminal conduct."
- "Address books prove participation."
...
- Do not name uncharged third parties unless the cited primary source and editorial need are approved.
- Do not put an uncharged person's face in the thumbnail.
- Do not imply guilt by association, travel, contact, party attendance, payment, or photograph.

...
- `evidence-briefs/todd-blanche-no-evidence.html`
- `evidence-data/blanche-no-evidence/source-manifest.json`
- `evidence-data/blanche-no-evidence/claims.json`
- `evidence-data/blanche-no-evidence/quote-verification.json`
- `evidence-data/blanche-no-evidence/hearing-exchanges.json`
- `evidence-data/blanche-no-evidence/records-vs-proof.json`
- `evidence-data/blanche-no-evidence/evidentiary-standards.json`
- `evidence-data/blanche-no-evidence/acquisition-gaps.json`
- `evidence-data/blanche-no-evidence/prosecution-decisions.json`
- `evidence-data/blanche-no-evidence/contradiction-audit.json`

Review order:

1. Read `editorial-brief.md`.
2. Read `narration.md` against `claim-ledger.json`.
...
- YouTube OAuth required: no
- Website public watch page: not generated
